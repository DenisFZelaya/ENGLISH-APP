...
import { GUARANTEE_HIPOTECARY_GENERAL_FIELDS, GUARANTEE_RESUME_FIELDS } from '../../../../../../fields/GuaranteesFields';
import { useGuarantees } from '../../../../../../navigations/GuaranteesContext';

export default function GuaranteeHipotecaryGeneralSection({ credit, handleChange, handleSubmit, values }) {
  ...
  return (
    <ScrollView style={className('p-4 bg-white dark:bg-gray-900')}>
      <View style={className('flex flex-row flex-wrap')}>
        ...
        {GUARANTEE_HIPOTECARY_GENERAL_FIELDS.map((field, index) => (
          <CustomField
            field={field}
            handleChange={handleChange}
            values={values}
